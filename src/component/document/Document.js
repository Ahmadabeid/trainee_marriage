...
const Document = () => {
  ...
  const loadDocument = async () => {
    const fetch = await axios.get(
      'http://localhost:8085/document/getDocuments',
      { headers }
    )
  ...
  const deleteDocument = async (docId) => {
    await axios.delete(
      `http://localhost:8085/document/deleteDocumentById/${docId}`,
      { headers }
    )
    loadDocument()
  }
    ...
    <>
      ...
      <div className="content-wrapper">
                  ...
                  <div className="card-header">
                    <div className="col-sm-2">
                      <Link to="/documentForm">
                        ...
                        >
                          <i class="fa fa-plus-alt"></i> Add Document
                        </button>
                      </Link>
                    </div>
                  </div>
                        ...
                        {document.map((document, index) => (
                          <tr>
                            ...
                            <td>
                              <center>
                                <Link
                                  to={`/viewDocument/${document.docId}`}
                                  class="btn btn-info"
                                >
        ...
        <i class="fa fa-plus-alt"></i> Add Document</button>
                                ...
                                <Link
                                  to={`/updateDocument/${document.docId}`}
